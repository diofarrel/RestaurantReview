...
class MainActivity : AppCompatActivity() {
    ...
    /*
        Di sini kita menggunakan fungsi enqueue untuk menjalankan request secara asynchronous di background. Sehingga aplikasi tidak freeze/lag ketika melakukan request.
    */
